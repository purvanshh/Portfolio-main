  ...
  return (
      <div className="about-container" id={id}>
        <div className="aboutMe-text">
          ...
          Want to know more about me? Feel free to <a className='resume' href="https://drive.google.com/file/d/1rIYF0g3-jXjgfjeNKCnM114-bfUCiPg9/view?usp=drivesdk" target="_blank" rel="noopener noreferrer">explore my resume.</a>
        </div>
